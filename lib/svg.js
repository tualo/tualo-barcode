...
SVG.prototype.toString=function(fullFile){
	if (fullFile===true){
		var dom = {
			tag: 'svg',
			attr:[
				{key: 'width',value: ((typeof this.width==='function')?this.width():this.width)+this.unit},
				{key: 'height',value: ((typeof this.height==='function')?this.height():this.height)+this.unit}
			],
			childs: this.dom
		};
